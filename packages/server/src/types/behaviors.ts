/**
 * Shared Behavior Types
 *
 * Single source of truth for behavior-related types used across
...
/**
 * One reaction-log entry for a window (from behavior_reactions). Surfaced on
 * get_behavior windows so the UI can show what the reaction script did.
 */
export const BehaviorWindowReactionSchema = Type.Object({
  id: Type.Integer(),
...
export type BehaviorWindowReaction = Static<typeof BehaviorWindowReactionSchema>;

/**
 * Behavior window data as returned by get_behavior
 */
export const BehaviorWindowSchema = Type.Object({
  ...
  reactions: Type.Optional(Type.Array(BehaviorWindowReactionSchema)),
});
export type BehaviorWindow = Static<typeof BehaviorWindowSchema>;
...
export const BehaviorVersionInfoSchema = Type.Object({
  version: Type.Integer(),
  name: Type.String(),
  created_at: Type.String(),
  is_current: Type.Boolean(),
});
export type BehaviorVersionInfo = Static<typeof BehaviorVersionInfoSchema>;

// ============================================
// Behavior metadata (returned by get_behavior)
// ============================================

const BehaviorRunSchema = Type.Object({
  run_id: Type.Integer(),
  status: Type.Union([
...
export const BehaviorMetadataSchema = Type.Object({
  ...
  /**
   * Optional FK into `device_workers.id` pinning this behavior (and its run)
  ...
  version: Type.Integer(),
  sources: Type.Array(BehaviorSourceSchema),
  ...
  available_versions: Type.Optional(Type.Array(BehaviorVersionInfoSchema)),
  reaction_script: Type.Optional(Type.String()),
  behavior_run: Type.Optional(BehaviorRunSchema),
