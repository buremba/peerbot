// ─────────────────────────────────────────────────────────────────────────────
// AGENTS.md exception: the subcommand handlers below are lazy-loaded via
// `await import("./commands/...")` rather than static imports. This is the
// single, documented exemption to AGENTS.md's "no dynamic imports" rule.
//
