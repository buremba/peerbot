...
const projectDesiredWatcher = (d: DesiredWatcher): WatcherProjection => ({
  ...
  sources: d.sources ?? [],
  reactionsGuidance: d.reactionsGuidance ?? null,
  deviceWorkerId: d.deviceWorkerId ?? null,
  notificationChannel: d.notificationChannel ?? null,
  notificationPriority: d.notificationPriority ?? null,
  minCooldownSeconds: d.minCooldownSeconds ?? null,
  tags: d.tags ?? [],
  agentKind: d.agentKind ?? null,
