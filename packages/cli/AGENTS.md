...
## Boundaries
- This is a published user-facing binary. Error messages are product surface — write them for someone who has never read this repo, and use the canonical **Behavior** vocabulary in anything a user or agent sees.
