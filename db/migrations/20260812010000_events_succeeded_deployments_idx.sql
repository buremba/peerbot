...
-- Additive only — no columns or tables change.
CREATE INDEX IF NOT EXISTS events_succeeded_deployments_idx
...
-- migrate:down
DROP INDEX IF EXISTS events_succeeded_deployments_idx;
