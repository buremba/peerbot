...
## Ingestion paths
1. **Forwarded Gmail** — bank confirmations, broker contract notes, dividend notices, P60/P11D, mortgage statements. Automation `personal-finance.gmail-tx` parses these automatically. Verify gaps and ask the user to forward what's missing.
