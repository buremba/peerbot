/**
 * Behavior Feedback Utilities
 *
 * Queries user-submitted corrections on behavior extraction results
...
/**
 * Build a human-readable summary of past user corrections for a behavior.
 *
