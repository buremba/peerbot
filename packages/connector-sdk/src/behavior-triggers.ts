...
/**
 * A connector-owned event that can activate a Behavior. These definitions are
 * catalog metadata: the UI, CLI, and agent tools render the same stable keys
 * without learning provider webhook names.
 */
export const ConnectorBehaviorEventSchema = Type.Object(
	{
...
export type ConnectorBehaviorEvent = Static<
	typeof ConnectorBehaviorEventSchema
>;
 ...
 */
export const ConnectorBehaviorSignalDraftSchema = Type.Object(
	{
...
export type ConnectorBehaviorSignalDraft = Static<
	typeof ConnectorBehaviorSignalDraftSchema
>;

/**
 * Small connector-normalized signal used to activate matching Behavior triggers.
