...
/** Adapt shared TextResult to Lobu's ToolResult (adds details field) */
...
export function createLobuCustomTools(params: {
  gatewayUrl: string;
  workerToken: string;
  channelId: string;
 ...
 * Lobu ToolDefinition objects that call the MCP proxy directly.
