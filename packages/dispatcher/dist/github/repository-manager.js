...
class GitHubRepositoryManager {
    octokit;
    config;
    repositories = new Map(); // username -> repository info
    constructor(config) {
        this.config = config;
     ...
     */
    async ensureUserRepository(username) {
        try {
            ...
            throw new GitHubRepositoryError("ensureUserRepository", username, `Failed to ensure repository for user ${username}`, error);
        }
    }
    /**
     * Create a new user repository
     */
    async createUserRepository(username) {
        try {
            ...
            throw new GitHubRepositoryError("createUserRepository", username, `Failed to create repository for user ${username}`, error);
        }
    }
    /**
     * Generate initial README content
     */
    generateInitialReadme(username) {
...
`;
     ...
     * Create initial directory structure
     */
    async createInitialStructure(owner, repositoryName) {
        const directories = [
            {
     ...
     */
    async getRepositoryInfo(username) {
